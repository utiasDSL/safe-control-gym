...
python3 ../../main.py --algo ppo --task cartpole --overrides ./config_overrides/ppo_config.yaml --output_dir ./ \
                    --tag unsafe_ppo_temp_data/ --kv_overrides task_config.ctrl_freq=10 task_config.info_in_reset=True task_config.pyb_freq=1000 --seed 2
