    ...
    def learn(self, env=None, **kwargs):
        ...
        while self.ite_counter < self.max_iterations:
            ...
            if self.ite_counter == 0:
                ...
                print(f'Cost increased by {-delta_cost}. ' + 'Set feedforward term and controller gain to that '
                ...
                if abs(delta_cost) < self.epsilon and self.prev_ite_improved:
                    # Cost converged.
                    print(colored('iLQR cost converged with a tolerance ' + f'of {self.epsilon}.', 'yellow'))
                    break
