...
if not generalization:
    ppo_data_path = '/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/PPO_traj.npy'
else:
    ppo_data_path = '/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/PPO_traj_gen.npy'
...
if not generalization:
    sac_data_path = '/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/SAC_traj.npy'
else:
    sac_data_path = '/home/mingxuan/Repositories/scg_tsung/benchmarking_sim/quadrotor/SAC_traj_gen.npy'
...
for i in range(gpmpc_traj_data.shape[1] - 1):
# for i in range(1):
    # ilqr
