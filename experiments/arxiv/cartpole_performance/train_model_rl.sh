...
bash utils/rl_cartpole.sh ppo train 
bash utils/rl_cartpole.sh sac train 
...
bash utils/rl_cartpole.sh ppo post_evaluate "seed*"
bash utils/rl_cartpole.sh sac post_evaluate "seed*"
