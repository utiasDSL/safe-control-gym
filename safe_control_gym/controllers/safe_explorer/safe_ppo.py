...
class SafeExplorerPPO(BaseController):
        ...
        while self.total_steps < final_step:
            ...
            if self.eval_interval and self.total_steps % self.eval_interval == 0:
                if self.pretraining:
                    ...
                    # TODO: no single criterion to determine best eval model
                else:
    ...
    def pretrain_step(self):
        ...
        self.constraint_buffer.reset()  # TODO: check perf. w/ & wo/ it.
    ...
    def train_step(self):
        ...
        self.agent.train()
        self.obs_normalizer.unset_read_only()
        rollouts = SafePPOBuffer(self.env.observation_space, self.env.action_space, self.num_constraints, self.rollout_steps, self.rollout_batch_size)
        obs = self.obs
        c = self.c
        start = time.time()
    ...
    def eval_constraint_models(self):
        ...
        self.constraint_buffer.reset()  # TODO: use a different buffer for evaluation
