...
class Controller():
    ...
    def cmdFirmware(self,
        ...
        elif iteration == int((TRAJECTORY_LENGTH+3)*self.CTRL_FREQ):
            command_type = Command(6)  # Notify setpoint stop.
            args = []
        
        elif iteration == int((TRAJECTORY_LENGTH+3)*self.CTRL_FREQ)+1:
            height = 0.
            duration = 3
        ...
        elif iteration == (TRAJECTORY_LENGTH+6)*self.CTRL_FREQ:
