...
if __name__ == "__main__":
    ...
    if config.plot_dir == '':
        ...
        fnames = [
            config.plot_dir+'traj_lin_mpc.csv',
            config.plot_dir+'traj_1.csv',
            config.plot_dir+'traj_2.csv',
            config.plot_dir+'traj_3.csv',
            config.plot_dir+'traj_4.csv',
        ]
        plot_impossible_traj_from_csv(fnames)
