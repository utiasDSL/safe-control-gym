...
class SafetyLayer:
    ...
    def get_safe_action(self, obs, act, c):
        ...
        According to the paper, this simple projection works when only 1 constraint
        is active at a time; for multiple active constriants, either consult in-graph
        QP solver like in OptLayer or consider cvxpylayers (https://github.com/cvxgrp/cvxpylayers)
        ...
        # Calculate correction, formula (6) from paper
